...
public class BaseDict {
    ...
    public BaseDict(Integer dictId, String dictTypeCode, String dictTypeName, String dictItemName, String dictItemCode, Integer dictSort, String dictEnable, String dictMemo) {
        this.dictId = dictId;
