...
<body  leftmargin=0 topmargin=0 marginheight=0 marginwidth=0 background="${pageContext.request.contextPath}/images/rightbg.jpg">
<div ALIGN="center">
    <table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table">
        <tr>
            <td height="93"></td>
            <td></td>
        </tr>
